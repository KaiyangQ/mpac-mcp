# MPAC v0.1.11 Developer Reference
...
| `version` | string | R | 协议版本，如 `"0.1.11"` |
...
MPAC v0.1.11 共 21 种消息类型，分布在 Session / Intent / Operation / Conflict / Governance / Error 六类中。
...
**并发裁决、claim 处置与活锁防护（v0.1.8+ / v0.1.11）：**
