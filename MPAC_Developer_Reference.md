...
| 4 | OPEN | RESOLVED | `RESOLUTION` received | resolver 对当前 conflict phase 有 authority（owner / arbiter / coordinator） | 执行 outcome，释放 frozen scope |
...
| 8 | ACKED | RESOLVED | `RESOLUTION` received | resolver 对当前 conflict phase 有 authority | 执行 outcome，释放 frozen scope |
