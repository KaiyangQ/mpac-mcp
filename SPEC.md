...
### 18.5 Resolution Causal Context
...
MPAC does not assume all participants are fully trusted.
...
High-trust and low-trust environments MAY apply different security models while remaining MPAC-compatible at the semantic layer.
...
- signature and trust chain formats
...
Its central design claim is that collaborative agent systems become more interoperable, auditable, and governable when intent, mutation, conflict, and resolution are represented as explicit protocol messages rather than hidden inside application logic.
