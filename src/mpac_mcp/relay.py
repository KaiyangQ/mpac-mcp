...
_SYSTEM_PROMPT = (
    ...
    "is working on them.\n"
    "     * If overlap exists AND you decide to YIELD (back off, don't join "
    "the conflict): call **defer_intent(files, observed_intent_ids=...)** "
    "with the intent_ids you saw — this surfaces a yield-chip in the user's "
    "Conflicts panel so siblings can see your decision. Then tell the user "
    "you yielded and stop.\n"
