...
_SYSTEM_PROMPT = (
    ...
    "between your check_overlap and announce). Continue to step 4 "
    "(write the files), but PREFIX your eventual reply to the user "
    "with the v0.2.11 ⚠️ warning template, naming "
    "{conflicts[0].other_display_name} + their_impact_on_us. The "
    "user can override with 'wait for X' / '让路' to make you "
    "withdraw + defer.\n"
    "\n"
